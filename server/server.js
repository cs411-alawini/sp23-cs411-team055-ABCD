...
app.put("/process-report/:ID", function(req, res) {
  ...
  db.query(query1,[parseInt(req.params.ID)] ,(err, res) => {
    if (err) {
      console.log(err)
    } else {
      console.log(res)
      if (res.length === 1) {
        ...
        db.query(query4, [req.body.Date_Rptd, req.body.DATE_OCC, req.body.TIME_OCC, req.body.Rpt_Dist_No, req.body.Crm_Cd, req.body.Vict_Age, req.body.Vict_Sex, req.body.Vict_Descent, req.body.Premis_Cd, req.body.Weapon_Used_Cd, req.body.Status, req.body.LOCATION, req.body.LAT, req.body.LON, parseInt(req.params.ID)], (err1, res1) => {
            if (err1) {
              console.log(err1)
            } else {
              console.log(res1)
